...
class BasicBattery(BaseBattery):
    ...
    def __init__(self, state_of_charge):
        ...
        # calculates discharge capacity from state of charge
        self.discharge_capacity = self.calculate_discharge_capacity_from_soc(self.state_of_charge)

        # calculates voltage of battery from discharge capacity
        self.voltage = self.calculate_voltage(self.discharge_capacity)

        # calculates stored energy from discharge capacity
        self.stored_energy = self.max_energy_capacity - self.calculate_energy_discharged_from_discharge_capacity(
    ...
    # assuming energy parameter is in joules
