...
extern void weather_in_time(GoFloat64* weather_forecast_Ptr, GoFloat64* linearized_results_Ptr, GoFloat64* unix_timestamps_Ptr, GoInt32* indices_Ptr, GoInt64 weather_coords, GoInt64 weather_times, GoInt64 weather_endpoints, GoInt64 simulation_duration);
extern void weather_in_time_loop(GoFloat64* unix_timestamps_inPtr, GoInt64* closest_time_stamp_indices_outPtr, GoFloat64* dt_local_array_inPtr, GoInt64 dt_local_array_inPtr_size, GoInt64 io_ptr_size);
