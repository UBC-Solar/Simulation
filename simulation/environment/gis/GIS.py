...
from simulation.environment.gis.base_gis import BaseGIS
...
if __name__ == "__main__":
    ...
    parser.add_argument("--route_file", '-r', help='Path to route file', required=True)

    args = parser.parse_args()

    route = process_KML_file(args.route_file)
    print(json.dumps(list(route)))
