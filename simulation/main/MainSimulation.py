...
class Simulation:
    ...
    def optimize(self, *args, **kwargs):
        ...
        arrays_to_plot = self._get_simulation_arrays(speed_result)
    ...
    # This is kind of terrible code since it's a bunch of copied code from run_model
    def _get_simulation_arrays(self, speed_kmh):
        tick_array = np.diff(self.timestamps)
        tick_array = np.insert(tick_array, 0, 0)
